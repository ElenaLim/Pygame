...
# 게임 배경화면
background = pygame.image.load('C://Users//user//manim//pygame_objs//background1.jpg') # 배경화면 사진 로드
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        # 플레이어 사진 불러오기
        self.image = pygame.image.load('C:/Users/user/manim/pygame_objs/chick.png')
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        # 적 사진 불러오기
        self.image = pygame.image.load('C:/Users/user/manim/pygame_objs/boom2.png')
        #이미지 크기의 직사각형 모양 불러오기
        self.rect = self.image.get_rect()
        # 이미지 시작 위치 설정 
...
# 게임 BGM 설정
bgm = pygame.mixer.Sound('C://Users//user//manim//pygame_objs//backgroundMusic.mp3')
bgm.play()
...
while True:
 ...
 #<Player Sprite(in 1 groups)>
    ...
    if pygame.sprite.spritecollideany(P1,Enemies):
        ...
        # 플레이어
        GameDisplay.blit(background,(0,0))
        image0 = pygame.image.load('C:/Users/user/manim/pygame_objs/chickbommed.png')
        image0.get_rect()
        GameDisplay.blit(image0,player_pos)

        # 폭탄
        image1 = pygame.image.load('C:/Users/user/manim/pygame_objs/boomm.png')
        image1.get_rect()
        ...
        bgm.stop()
        # 적과 충돌시 효과음 추가
        pygame.mixer.Sound('C://Users//user//manim//pygame_objs//BOOM.WAV').play()
        time.sleep(0.5)
        # 게임오버화면 설정
        pygame.mixer.Sound('C://Users//user//manim//pygame_objs//gameover.mp3').play()
